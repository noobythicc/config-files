...
-- Separator
separator = wibox.widget { orientation = "vertical", forced_width = 10, widget = wibox.widget.separator }

-- Space
space = wibox.widget { markup = " ", widget = wibox.widget.textbox }
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " TERM ", " WEB ", " DEV ", " CHAT ", "VIRT", " GAMES", " MISC "}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,		  }, "d", function () awful.spawn("dmenu_run") end,
    	      {description = "start dmenu", group = "custom"}),
...
awful.spawn.with_shell("xinput set-prop '1A58200E:00 06CB:CD73 Touchpad' 'libinput Tapping Enabled' 1")

-- nice gaps
beautiful.useless_gap = 10

-- wallpaper
gears.wallpaper.maximized("/home/user/.config/awesome/background-pic", s)
